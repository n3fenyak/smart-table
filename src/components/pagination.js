...
export const initPagination = (
  ...
  // @todo: подготовить шаблон кнопки для страницы и очистить контейнер
  ...
  const updatePagination = (total, { page, limit }) => {
    ...
    // @todo: получить список видимых страниц и вывести их
    ...
    // @todo: обновить статус пагинации
