...
function collectState() {
  const state = processFormData(new FormData(sampleTable.container)) // состояние полей таблицы
  state.total = [state.totalFrom, state.totalTo] // объединяем диапазон total  в массив
